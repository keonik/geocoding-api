...
// Legend payload type for Recharts 3
    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5">
          {(payload ?? [])
            .filter((item: TooltipPayload<string | number, string>) => item.type !== "none")
            .map((item: TooltipPayload<string | number, string>, index: number) => {
